...
import { showFiles } from './fileHandler.js'
import {
    formTitle,
...
export function renderSeasons (seasonArray){
        ...
        return `
            <div class="season">
                ...
                <div class="btn-wrapper">
                    <button id="editSeasonBtn" data-season-number="${season.seasonNumber}" class="btn">
                        <span class="btn-text">Edit</span>
                        <div class="btn-loader"></div>
                    </button>
                    <button id="removeSeasonBtn" data-season-number="${season.seasonNumber}" class="btn">
    ...
    initSeasonsEventListeners()
}

export function renderEpisodes (seasonNumber){
    ...
    initEpisodesEventListeners()
}

export async function removeSeason(e, seasonNumber) {
...
export async function removeEpisode (episodeNumber, seasonNumber) {
